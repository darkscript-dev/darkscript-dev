...
<p>
  ...
  <img src="https://img.shields.io/badge/RoomDB-8A6348?style=for-the-badge" alt="RoomDB"/>
  <img src="https://img.shields.io/badge/SQL-4479A1?style=for-the-badge&logo=postgresql&logoColor=white" alt="SQL"/>
  <img src="https://img.shields.io/badge/RESTful%20APIs-orange?style=for-the-badge" alt="REST API"/>
  <img src="https://img.shields.io/badge/Data%20Parsing-JSON-black?style=for-the-badge&logo=json&logoColor=white" alt="Data Parsing"/>
</p>
...
<p>
  ...
  <img src="https://img.shields.io/badge/Cloud%20Deployment-Hugging%20Face-FFD21E?style=for-the-badge&logo=huggingface&logoColor=black" alt="Hugging Face"/>
...
| :--- | :--- | :--- | :--- |
| **Lyra** | [**Google Play Store**](https://play.google.com/store/apps/details?id=dev.darkscripts.lyra) | An ambient sound and focus application **published on the Google Play Store**, focused on clean architecture and a user-centric interface. | `Flutter` `Dart` `Android` |
| **Solana DeFi Automation** | [**Project Overview**](https://github.com/darkscript-dev/Solana-DeFi-Automation-Project) | An automated, high-frequency trading bot for Solana, featuring real-time on-chain data analysis, multi-layered security auditing, and algorithmic risk management. | `Python` `Solana` `WebSockets` `Docker` |
| **DevAI** | **[*]()** | *coming soon !!!* | `*`|
...
| **Generative Lo-fi Engine** | [**Repository**](https://github.com/darkscript-dev/flutter-generative-lofi-engine)| An experimental Flutter app exploring procedural generation of ambient music and soundscapes. | `Flutter` `Dart` `Audio Processing` |
