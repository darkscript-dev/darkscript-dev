...
| :--- | :--- | :--- | :--- |
| **SmartSpend AI** | [**Project Overview**](https://github.com/darkscript-dev/SmartSpendAI-Project-Overview-) | An intelligent, offline-first expense tracker built with Modern Android standards, featuring on-device Machine Learning (OCR) for receipt scanning and live currency conversion via a remote API. | `Kotlin` `Jetpack Compose` `Room` `Hilt` `Retrofit` `ML Kit` |
